...
juce_add_plugin(RNBOAudioPlugin
  ...
  # ICON_SMALL ...
  COMPANY_NAME "ES Mediaworks LLC"     # Specify the name of the plugin's author
  ...
  PLUGIN_MANUFACTURER_CODE "Esmw"      # A four-character manufacturer id with at least one upper-case character
  PLUGIN_CODE "Esmw"                   # A unique four-character plugin id with at least one upper-case character
  FORMATS ${PLUGIN_FORMATS}            # The formats to build. Other valid formats are: AAX Unity VST AU AUv3
  PRODUCT_NAME "Crystallophon")          # The name of the final executable, which can differ from the target name
...
target_compile_definitions(RNBOAudioPlugin PRIVATE
    JUCE_COREGRAPHICS_DRAW_ASYNC=1
    JUCE_USE_DIRECTWRITE=1
    JUCE_ENABLE_REPAINT_DEBUGGING=0
)

# macOS Retina rendering
if(APPLE)
    target_compile_definitions(RNBOAudioPlugin PRIVATE
        JUCE_USE_COREGRAPHICS_RENDERING=1
    )
endif()
